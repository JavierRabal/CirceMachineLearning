...
# ydata-profiling: librería para generar reportes de análisis exploratorio de datos.
# pip install ydata-profiling
from ydata_profiling import ProfileReport


#streamlit-ydata-profiling: librería para integrar ydata-profiling con streamlit.
...
if archivo is not None:
    ...
    if btnGenerar:
        ...
        pr = ProfileReport(archivo1)
        # Muestra el reporte en Streamlit
        st_profile_report(pr)


## Ejecutar con streamlit run /home/jrabal/Documentos/venv_ML/ML/app_ydata_profiling.py